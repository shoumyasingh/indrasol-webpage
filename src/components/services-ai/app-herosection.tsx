...
import { ArrowRight, Shield, Code, CheckCircle, ChevronRight, ArrowUpRight, Lock, Database } from "lucide-react";
...
export function AppHeroSection({ 
  ...
  title = "Secure Every Layer Of Your Application Stack.",
  ...
  const breadcrumbItems = [
    ...
    { label: 'Application Security & Compliance', link: null } // Current page has no link
  ];

  // Configuration data for feature badges
  const featureBadges = [
    { icon: Shield, text: "Vulnerability Management" },
    { icon: Code, text: "Secure Development" },
    { icon: Lock, text: "Compliance & Standards" }
  ];
  ...
  const formatTitle = () => {
    if (title === "Secure Every Layer Of Your Application Stack.") {
      return (
        <>
          <span className="text-black">Secure </span>
          <span className="text-indrasol-blue"> Every </span>
          <span className="text-black">Layer</span>
          <span className="text-indrasol-blue"> Of Your </span>
          <span className="text-black"> Application </span>
          <span className="text-indrasol-blue"> Stack. </span>
        </>
      );
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-5">
            ...
            <div className="inline-block bg-indrasol-blue/10 px-4 py-1 rounded-full mb-1">
              <span className="text-indrasol-blue font-semibold text-sm">Application Security  & Compliance</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 pl-1">
                <BulletPoint>Application Security Posture Management (ASPM)</BulletPoint>
                <BulletPoint>Penetration Testing (Web, API, AI Applications)</BulletPoint>
                <BulletPoint>SaaS Security & Compliance (SOC 2, ISO 27001, HIPAA, GDPR)</BulletPoint>
                <BulletPoint>Data Governance & Privacy (PII, HIPAA, GDPR)</BulletPoint>
              </ul>
            </div>
              ...
              <div className="relative overflow-hidden rounded-xl group">
                {withVideo && videoSrc ? (
                  <video 
                    ...
                    poster="/services-security/image-for-hero-section.png"
                  >
                    <source src={videoSrc} type="video/mp4" />
                    <img 
                      src="/services-security/image-for-hero-section.png" 
                      alt="Application security visualization" 
                      className="w-full rounded-xl shadow-xl"
                    />
                  </video>
                ) : (
                  <img 
                    src="/lovable-uploads/app-herosection.png" 
                    alt="Application security visualization" 
