      ...
      >
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-xl text-gray-700 leading-relaxed">
            We combine cutting-edge AI development with industry-leading
            security practices to help organizations build and deploy
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-gradient-to-br from-indrasol-blue/10 to-white rounded-2xl p-12 text-center">
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
              Get in touch to discuss how our AI development and security
              expertise can help your organization innovate safely.
            </p>
            <Link
              to="/contact"
