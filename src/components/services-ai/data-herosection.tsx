...
import { ArrowRight, Database, BarChart, LineChart, CheckCircle, ChevronRight, ArrowUpRight } from "lucide-react";
...
export function DataHeroSection({ 
  ...
  title = "Turn data into a strategic advantage.",
  ...
  const breadcrumbItems = [
    ...
    { label: 'Data Engineering, Analytics & Security', link: null } // Current page has no link
  ];

  // Configuration data for feature badges
  const featureBadges = [
    { icon: Database, text: "Data Pipelines" },
    { icon: BarChart, text: "Data Warehousing" },
    { icon: LineChart, text: "Analytics Solutions" }
  ];
  ...
  const formatTitle = () => {
    if (title === "Turn data into a strategic advantage.") {
      return (
        <>
          <span className="text-black">Turn </span>
          <span className="text-indrasol-blue"> Data </span>
          <span className="text-black">Into A</span>
          <span className="text-indrasol-blue"> Strategic Advantage.</span>
        </>
      );
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-5">
            ...
            <div className="inline-block bg-indrasol-blue/10 px-4 py-1 rounded-full mb-1">
              <span className="text-indrasol-blue font-semibold text-sm">Data Engineering, Analytics & Security</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 pl-1">
                <BulletPoint>EPM, Data Pipeline Architecture & ETL/ELT Engineering</BulletPoint>
                <BulletPoint>Secure Data Platforms (e.g., Snowflake, Databricks)</BulletPoint>
                <BulletPoint>Enterprise Performance Management (EPM)</BulletPoint>
                <BulletPoint>Data Governance & Privacy (PII, HIPAA, GDPR)</BulletPoint>
                <BulletPoint>Data Security Posture Management (DSPM)</BulletPoint>
              </ul>
            </div>
